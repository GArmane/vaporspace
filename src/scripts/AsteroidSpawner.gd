...
const asteroids = [
	preload("res://src/scenes/entities/obstacles/AsteroidLarge01.tscn"),
	preload("res://src/scenes/entities/obstacles/AsteroidLarge02.tscn"),
	preload("res://src/scenes/entities/obstacles/AsteroidMedium01.tscn"),
	preload("res://src/scenes/entities/obstacles/AsteroidSmall01.tscn"),
]
